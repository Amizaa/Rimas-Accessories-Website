...
<div class="space-y-4">
        ...
        <div class="flex space-x-4 justify-center">
          ...
          <a href="https://t.me/RIMASACCESSOR" class="text-gray-400 hover:text-blue-400 transition">
            <span class="sr-only">Telegram</span>
            <svg class="h-6 w-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
